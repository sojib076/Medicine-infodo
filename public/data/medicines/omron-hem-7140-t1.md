...
Have your child rest their arm, palm facing up, where it will stay still. The Omron (HEM-7140-T1) cuff will need to be placed at about the same level as the heart. 
...
- Put the cuff on and squeeze the bulb quickly to fill (inflate) it with air. The cuff should inflate to a number at least 30 higher than the expected systolic pressure. If your child is taking their own Omron (HEM-7140-T1), they should grasp the bulb with the hand opposite the arm the cuff is on.
...
- heart rate.
- If the machine was not able to take the Omron (HEM-7140-T1), the display would show a flashing arrow pointing up. You will need to start over. This time, pump the bulb a little higher than
