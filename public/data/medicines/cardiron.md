## Indications
Cardiron tablet is used for many serious arrhythmias of the heart including ventricular fibrillation, ventricular tachycardia, atrial fibrillation, and atrial flutter. 

Cardiron injection is an antiarrhythmic agent indicated for initiation of treatment and prophylaxis of frequently recurring ventricular fibrillation (VF) and hemodynamically unstable ventricular tachycardia (VT) in patients refractory to other therapy.
...
## Interaction
Cardiron may interact with b blockers such as Atenolol, Propranolol, Metoprolol, or certain calcium channel blockers, such as Verapamil or Diltiazem, resulting in an excessively slow heart rate. Cardiron increases the blood levels of Digoxin when the two drugs are given together. Flecainide blood concentrations increase by more than 50% with Cardiron. Procainamide and Quinidine concentrations increase by 30-50% during the first week of Cardiron therapy. Cardiron also can interact with tricyclic antidepressants (TCA). Cardiron interacts with Warfarin and increases the risk of bleeding. Cardiron inhibits the metabolism of Dextromethorphan.
