## Indications
Chlorool is an antibiotic that is clinically useful for, and should be reserved for, serious infections caused by organisms susceptible to its antimicrobial effects when less potentially hazardous therapeutic agents are ineffective or contraindicated. However, Chlorool may be chosen to... Read moreChlorool is an antibiotic that is clinically useful for, and should be reserved for, serious infections caused by organisms susceptible to its antimicrobial effects when less potentially hazardous therapeutic agents are ineffective or contraindicated. However, Chlorool may be chosen to initiate antibiotic therapy on the clinical impression that one of the conditions below is believed to be present. In vitro sensitivity tests should be performed concurrently so that the drug may be discontinued as soon as possible if less potentially dangerous agents are indicated by such tests. The decision to continue use of Chlorool, rather than another antibiotic when both are suggested by in vitro studies to be effective against a specific pathogen, should be based upon severity of the infection, susceptibility of the pathogen to the various antimicrobial drugs, and the efficacy of the various drugs in the infection
...
## Interaction
Chlorool has been shown to retard the biotransformation of tolbutamide, phenytoin, and dicoumarol in man. Chlorool should be used with caution if administered concomitantly with lincomycin, clindamycin, or erythromycin. In vitro experiments have demonstrated that binding sites for erythromycin, lincomycin, clindamycin and Chlorool overlap and competitive inhibition may occur. Rifampin therapy can reduce Chlorool concentrations.
...
## Overdose Effects
Levels exceeding 25 mcg/ml are frequently considered toxic. Chlorool toxicity can be evidenced by serious hemopoietic effects such as aplastic anemia, thrombocytopenia, leukopenia, as well as increasing serum iron levels, nausea, vomiting and diarrhea. In the case of serious overdosage, charcoal hemoperfusion may be effective in removing Chlorool from plasma. Exchange transfusion is of questionable value following massive overdosage, especially in neonates and infants.
