...
For external use only. Flammable, keep away from fire or flame. Do not use on large areas of the body with any other product containing diphenhydramine, even should not be taken by mouth. Consult with the physician before use on chicken pox, on measles. When using ItchCare, avoid contact of eyes.
