## Indications
Floren tablet is indicated for the treatment of premenopausal women with acquired, generalized hypoactive sexual desire disorder (HSDD) as characterized by low sexual desire that causes marked distress or interpersonal difficulty and is not due to: 
...
## Interaction
Oral Contraceptives and Other Weak CYP3A4 Inhibitors : Increases Floren exposures and incidence of adverse reactions. 
Strong CYP2C19 Inhibitors : Increases Floren exposure which may increase risk of hypotension, syncope, and CNS depression. 
CYP3A4 Inducers : Use of Floren not recommended; Floren concentrations substantially reduced. 
...
Patients with pre-syncope should immediately lie supine and promptly seek medical help if symptoms do not resolve. Exacerbated by other CNS depressants and in settings where Floren concentrations are increased. Patients should avoid activities requiring full alertness (e.g., operating machinery or driving) until at least 6 hours after each dose and until they know how Floren affects them.
