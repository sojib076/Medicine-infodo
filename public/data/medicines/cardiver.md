## Indications
Cardiver is indicated to reduce the risk of cardiovascular death and heart failure (HF) hospitalization following a hospitalization for heart failure or need for outpatient IV diuretics, in adults with symptomatic chronic HF and ejection fraction less than 45%.
...
## Interaction
Other Soluble Guanylate Cyclase Stimulators : Cardiver is contraindicated in patients with concomitant use of other soluble guanylate cyclase (sGC) stimulators. 

PDE-5 Inhibitors : Concomitant use of Cardiver with PDE-5 inhibitors is not recommended because of the potential for hypotension. 

With food & others : Cardiver should be taken with food. The absolute bioavailability of Cardiver is 93% when taken with food.

## Contraindications
Vericiguat is contraindicated in patients with concomitant use of other soluble guanylate cyclase (sGC) stimulators.

## Side Effects
Common Side effects: The most common side effects of Cardiver tablet include low blood pressure & low red blood cells (Anemia).
...
Cardiver should not be administered to a pregnant female because it may cause fetal harm. Obtain a pregnancy test in females of reproductive potential prior to initiating treatment with Cardiver. Pregnancy should be excluded before the start of treatment. To prevent pregnancy, females of reproductive potential must use effective forms of contraception during treatment and for one month after stopping treatment.

## Overdose Effects
Limited data are available with regard to overdosage in human patients treated with Cardiver. Doses up to 10 mg have been studied. In a study of patients with preserved ejection fraction heart failure (left ventricular ejection fraction ≥45%), multiple doses of Cardiver 15 mg have been studied and were generally well tolerated. In the event of an overdose, hypotension may result. Symptomatic treatment should be provided. Cardiver is unlikely to be removed by hemodialysis because of high protein binding.
