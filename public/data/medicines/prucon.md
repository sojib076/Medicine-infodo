## Indications
Prucon tablet is indicated for symptomatic treatment of chronic constipation in adults in whom laxatives fail to provide adequate relief.
...
## Interaction
In-vitro data indicate that, Prucon has a low interaction potential and therapeutic concentrations of Prucon are not expected to affect the CYP-mediated metabolism of co medicated medicinal products. Although Prucon may be a weak substrate for P-glycoprotein (P-gp), it is not an inhibitor of P-gp at clinically relevant concentrations. 
...
Studies in healthy subjects showed that, there were no clinically relevant effects of Prucon on the pharmacokinetics of warfarin, digoxin, alcohol, paroxetine or oral contraceptives.
...
## Side Effects
The most frequently reported adverse reactions associated with Prucon therapy are headache (17.8%) and gastrointestinal symptoms (abdominal pain), nausea and diarrhoea. The adverse reactions occur predominantly at the start of therapy and usually disappear within a few days with continued treatment. Other adverse reactions have been reported occasionally. The majority of adverse events were mild to moderate in intensity.
...
- Caution should be exercised when prescribing Prucon to patients with severe hepatic impairment (Child-Pugh class C) due to limited data in patients with severe hepatic impairment.
...
## Overdose Effects
An overdose may result in symptoms resulting from an exaggeration of prucalopride's known pharmacodynamic effects and include headache, nausea and diarrhoea. Specific treatment is not available for Prucon overdose. Should an overdose occur, the patient should be treated symptomatically and supportive measures instituted, as required. Extensive fluid loss by diarrhoea or vomiting may require correction of electrolyte disturbances.
