## Indications
Gensulin R Injection is indicated in- 
...
## Overdose Effects
Gensulin Rs have no specific overdose definitions. However, hypoglycaemia may develop over sequential stages: 
...
## Storage Conditions
Gensulin R preparations should be stored between 2°C and 8°C (in a refrigerator). Gensulin R preparations which have been frozen must not be used. Gensulin R preparation should be kept in the outer carton in order to protect from light. Gensulin R preparations should be protected from excessive heat or sunlight. Gensulin R solutions should not be used if they do not appear water-clear and colorless. When in use the vial should not be refrigerated. Once in use the vial may be used for up to 6 weeks when stored below 25°C or 4 weeks when stored below 30°C.