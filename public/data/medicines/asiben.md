## Indications
Asiben is indicated in single and mixed infestations of- 
...
## Description
Asiben is a benzimidazole anthelmintic, active against most nematodes and some cestodes. It is used in the treatment of intestinal nematode infections and in higher doses in the treatment of hydatid disease. Asiben exhibits vermicidal, ovicidal, and larvicidal activity. The principal mode of action of Asiben is its inhibitory effect on tubulin polymerization, which results in the loss of cytoplasmic microtubules.
...
## Interaction
No interaction involving Asiben, either pharmacodynamic or pharmacokinetic, has been reported.
...
Blood counts and liver function tests before treatment and twice during each cycle; breastfeeding; exclude pregnancy before starting treatment. Asiben should only be used in the treatment of Echinococcosis if there is constant medical supervision with regular monitoring of serum-transaminase concentrations and of leucocyte and platelet counts
