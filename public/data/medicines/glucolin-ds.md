...
Serum glucose concentration should be carefully monitored. Concurrent use of insulin may be needed in case of diabetic patients. Glucolin DS solution should not be mixed with whole blood as haemolysis and clumping may occur. Infusion of fluid should be immediately discontinued if rigor arises for any reasons during the process. Do not use if the solution is cloudy, contains particles, or after expiry date. 

Take special care with Glucolin DS. Check with your doctor before taking this medicine if: You should not use this medication if you are allergic to Glucolin DS. 

To make sure you can safely use Glucolin DS 5% in water, tell your doctor if you have any of these other conditions: 
