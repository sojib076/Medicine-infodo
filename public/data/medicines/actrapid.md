## Indications
Actrapid Injection is indicated in- 
...
## Overdose Effects
Actrapids have no specific overdose definitions. However, hypoglycaemia may develop over sequential stages: 
...
## Storage Conditions
Actrapid preparations should be stored between 2°C and 8°C (in a refrigerator). Actrapid preparations which have been frozen must not be used. Actrapid preparation should be kept in the outer carton in order to protect from light. Actrapid preparations should be protected from excessive heat or sunlight. Actrapid solutions should not be used if they do not appear water-clear and colorless. When in use the vial should not be refrigerated. Once in use the vial may be used for up to 6 weeks when stored below 25°C or 4 weeks when stored below 30°C.