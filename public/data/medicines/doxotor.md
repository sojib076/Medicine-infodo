...
## Interaction
Doxotor is a major substrate of cytochrome P450 CYP3A4 and CYP2D6, and P-glycoprotein (P-gp). Avoid concurrent use of Doxotor HCl with inhibitors and inducers of CYP3A4, CYP2D6, or P-gp. Concurrent use of Trastuzumab and Doxotor HCl results in an increased risk of cardiac dysfunction. Avoid concurrent administration of Doxotor and Trastuzumab. Paclitaxel, when given prior to Doxotor HCl, increases the plasma-concentrations of Doxotor and its metabolites. Administer Doxotor HCl prior to Paclitaxel if used concomitantly.
