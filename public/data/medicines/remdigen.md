## Indications
Emergency use of Remdigen for treatment of suspected or laboratory confirmed Corona Virus Disease 2019 (COVID-19). Severe disease is defined as patients with an oxygen saturation (Sp02) <94% on room air or requiring supplemental oxygen or requiring mechanical ventilation or requiring extracorporeal... Read moreEmergency use of Remdigen for treatment of suspected or laboratory confirmed Corona Virus Disease 2019 (COVID-19). Severe disease is defined as patients with an oxygen saturation (Sp02) <94% on room air or requiring supplemental oxygen or requiring mechanical ventilation or requiring extracorporeal membrane oxygenation (ECMO). Specifically, Remdigen is only authorized for hospitalized adult and pediatric patients for whom use of an intravenous agent is clinically appropriate.
...
## Side Effects
An adverse reaction associated with Remdigen in clinical trials in healthy adult subjects was increased liver transaminases.
...
There are limited clinical data available for Remdigen. Serious and unexpected adverse events may occur that have not been previously reported with Remdigen use.
...
- Aseptically reconstitute Remdigen lyophilized powder by addition of 19 ml of sterile water for injection using a suitably sized syringe and needle per vial.
...
## Storage Conditions
Please do not reuse or save unused Remdigen Lyophilized powder, injection solution or diluted solution for infusion for further use. Remdigen contains no preservatives. 

Lyophilized Powder : Please store Remdigen for injection, 100 mg, vials at temperature not exceeding 30°C in a dry place until required for use. Protect from light & moisture. Do not use after expiration date. 
...
Diluted Solution for Infusion : Please store diluted Remdigen solution for infusion up to 4 hours at room temperature (20°C-25°C) or 24 hours at refrigerated temperature (2°C-8°C).