...
## Interaction
Antacids may reduce the bioavailability of Nepsy by up to 20 %. Cimetidine may alter its reanal excretion. Nepsy does not interact with other anti-epileptic drug or with oral contraceptive preparations.
...
Patients should be instructed to take Nepsy only as prescribed. While using Nepsy patients should be instructed either not to drive a car or to operate other complex machinery until they have gained sufficient experiences about Nepsy whether or not it affects their mental and/or motor performance adversely.

## Use in Special Populations
In case of renal impaired patients Nepsy doses must be reduced.
