## Indications
Femogest is indicated for the treatment of endometriosis. Femogest belongs to the class of medications called progestins. Progestins reduce the effects of estrogen on tissues such as the endometrium (lining of the uterus) and the breast. By reducing the growth effect of estrogen on the endometrium, Femogest helps to reduce the pelvic pain experienced by women with endometriosis.
...
## Side Effects
Undesirable effects are more common during the 1st months after start of intake of Femogest, and subside with duration of treatment. The following undesirable effects have been reported in users of Femogest. The most frequently reported undesirable effects during treatment that were considered at least possibly related to Femogest were headache (9%), breast discomfort (5.4%), depressed mood (5.1%) and acne (5.1%). 
...
Before starting Femogest treatment, pregnancy must be excluded. During treatment, patients are advised to use nonhormonal methods of contraception (e.g, barrier method) if contraception is required. 

As Femogest is a progestogen-only preparation, it can be assumed that special warnings and special precautions for use of other progestogen-only preparations are also valid for the use of Femogest . 

- Changes in Bleeding Pattern: Femogest treatment affects the menstrual bleeding pattern in the majority of women.
- Hepatic Impairment: Femogest is contraindicated in patients with present or past severe hepatic disease.
- Impairment of Fertility: Based on available data, ovulation is inhibited in the majority of patients during treatment with Femogest. However, Femogest is not a contraceptive. If contraception is required, a nonhormonal method should be used.

## Use in Special Populations
Use in Children: Femogest is not indicated in children prior to menarche. The safety and efficacy of Femogest in adolescents (menarche to 18 years) has not yet been established. 

Use in the Elderly: There is no relevant indication for the use of Femogest in the geriatric population.

## Overdose Effects
Acute toxicity studies performed with Femogest did not indicate a risk of acute adverse effects in case of inadvertent intake of a multiple of the daily therapeutic dose. There is no specific antidote. Femogest 20-30 mg/day (10-15 times higher dose than in Femogest) over 24 weeks of use were very well tolerated.
