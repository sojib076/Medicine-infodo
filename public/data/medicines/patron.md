...
## Interaction
In controlled clinical trials, Patron injection has been safely administered with corticosteroids, analgesics, antiemetics/antinauseants, antispasmodics and anticholinergic agents. Patron did not inhibit the antitumor activity of cisplatin, cyclophosphamide, cytarabine, doxorubicin and mitomycin C in murine tumor models. Concomitant administration of Patron and metoclopramide has no significant pharmacokinetic interactions. In vitro studies indicated that Patron is not inhibitor of CYP1A2, CYP2A6, CYP2B6, CYP2C9, CYP2D6, CYP2E1 & CYP3A4/5 (CYP2C19 was not investigated) nor does it induce the activity of CYP1A2, CYP2D6 or CYP3A4/5. Therefore, the potential for clinically significant drug interactions with Patron appears to be low.
...
## Overdose Effects
There is no known antidote to Patron. Overdose should be managed with supportive care.
