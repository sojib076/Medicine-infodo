## Indications
Erenzo is indicated for the treatment of adult patients with symptomatic anemia associated with chronic kidney disease (CKD).

## Description
Erenzo is a frst-in-class, orally administered HIF-PH inhibitor that promotes erythropoiesis through increasing endogenous production of erythropoietin, as well as improving iron regulation and overcoming the EPO-suppressive efects of infammation on hemoglobin syntheses and red blood cell production by downregulating hepcidin.
...
## Interaction
Erenzo in combination with other medications may have drug-drug interaction. 

Erenzo with Phosphate binders and other products containing multivalent cation (EXCEPT) lanthanum carbonate: 

- Risk: decreased Erenzo AUC by 67% and 46% and Cmax by 66% and 52%
- Recommendation: Erenzo should be taken at least 1 hour after administration of phosphate binders or other medicinal products or supplements containing multivalent cations.
Erenzo with gemfbrozil (CYP2C8 and OATP1B1inhibitor) or probenecid (UGT and OAT1/OAT3 inhibitor) 

- Risk: increased Erenzo AUC by 2.3- fold and Cmax by 1.4-fold
- Recommendation: Adjust the dose of Erenzo following dose adjustment rules based on Hb monitoring.
Erenzo with OATP1B1 or BCRP Substrates (simvastatin, rosuvastatin & atorvastatin) 

- Risk: AUC and Cmax increased
- Recommendation: Adjust the dose of Erenzo following dose adjustment rules based on Hb monitoring.

## Side Effects
The common adverse reactions associated with Erenzo are hypertension, vascular access thrombosis, diarrhoea, peripheral oedema, hyperkalaemia and nausea.

## Pregnancy & Lactation
Do not administered to women that may be pregnant or pregnant. Roxadustat is contraindicated during breast-feeding.

## Precautions & Warnings
Erenzo tablets should be used in caution. It may initiate few thrombotic vascular events (TVEs) particularly in patients with pre-existing risk factors for TVE, including obesity and prior history of TVEs. Erenzo should be used with caution in patients with a history of seizures. Erenzo should not be administered if the patient has serious signs and symptoms of an infection. Erenzo should not be administered if the patient has liver disorder. Erenzo should not be initiated in pregnant women.

## Use in Special Populations
Children : Erenzo is not indicated in children. 

liver dysfunction patients : Erenzo is not recommended for use in patients with severe hepatic impairment.

## Overdose Effects
Symptoms : When Erenzo was administered 5 mg/kg (510 mg) to a single healthy adult, increased heart rate transient have been reported. Hemoglobin concentration by overdosage of Erenzo is likely to increase more than necessary. 

Treatment : Appropriate measures of dose reduction or interruption, etc. of Erenzo. Erenzo is not removed by dialysis.
