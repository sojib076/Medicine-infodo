## Indications
Bupi is indicated for the production of local or regional anaesthesia or analgesia for surgery, for oral surgery procedures, for diagnostic and therapeutic procedures, and for obstetrical procedures. The routes of administration and indicated Bupi concentrations are: 
...
## Interaction
Bupi should be used with caution in patients receiving other local anaesthetics or agents structurally related to amide‐type local anaesthetics, e.g. certain anti‐arrhythmics, such as lidocaine and mexiletine, since the systemic toxic effects are additive.Specific interaction studies with Bupi and anti arrhythmic drugs class III (e.g. amiodarone) have not been performed, but caution should be advised.
