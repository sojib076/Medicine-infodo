## Indications
Flumetol (with device) is indicated in the regular treatment of asthma where use of a combination product (long-acting β2-agonist and inhaled corticosteroid) is appropriate: 
...
## Overdose Effects
No human over dosage data has been reported for Flumetol (with device) inhaler; however data on overdose with both drugs are given below: 
