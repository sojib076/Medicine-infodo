...
## Description
Fungin is a broad-spectrum antifungal agent that is used for the treatment of dermal infections caused by various species of pathogenic dermatophytes, yeasts, moulds and bacteroids. Fungin is also active against certain gram-positive bacteria especially Staphylococci and Tricomonas. Like other imidazoles, Fungin alters the permeability of fungal cell walls by interfering with cell wall lipids. At fungi static levels the main effect is inhibition of ergosterol synthesis but at higher concentrations there is an additional mechanism of membrane damage unrelated to sterol synthesis.
...
## Side Effects
When applied topically, Fungin is well tolerated.With external application, systemic effects are not observed. Local irritation or burning sensation may occur in a very few cases but these symptoms are not considered harmful.
