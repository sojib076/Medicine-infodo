## Indications
Metrinor is indicated for the treatment of endometriosis. Metrinor belongs to the class of medications called progestins. Progestins reduce the effects of estrogen on tissues such as the endometrium (lining of the uterus) and the breast. By reducing the growth effect of estrogen on the endometrium, Metrinor helps to reduce the pelvic pain experienced by women with endometriosis.
...
## Side Effects
Undesirable effects are more common during the 1st months after start of intake of Metrinor, and subside with duration of treatment. The following undesirable effects have been reported in users of Metrinor. The most frequently reported undesirable effects during treatment that were considered at least possibly related to Metrinor were headache (9%), breast discomfort (5.4%), depressed mood (5.1%) and acne (5.1%). 
...
Before starting Metrinor treatment, pregnancy must be excluded. During treatment, patients are advised to use nonhormonal methods of contraception (e.g, barrier method) if contraception is required. 

As Metrinor is a progestogen-only preparation, it can be assumed that special warnings and special precautions for use of other progestogen-only preparations are also valid for the use of Metrinor . 

- Changes in Bleeding Pattern: Metrinor treatment affects the menstrual bleeding pattern in the majority of women.
- Hepatic Impairment: Metrinor is contraindicated in patients with present or past severe hepatic disease.
- Impairment of Fertility: Based on available data, ovulation is inhibited in the majority of patients during treatment with Metrinor. However, Metrinor is not a contraceptive. If contraception is required, a nonhormonal method should be used.

## Use in Special Populations
Use in Children: Metrinor is not indicated in children prior to menarche. The safety and efficacy of Metrinor in adolescents (menarche to 18 years) has not yet been established. 

Use in the Elderly: There is no relevant indication for the use of Metrinor in the geriatric population.

## Overdose Effects
Acute toxicity studies performed with Metrinor did not indicate a risk of acute adverse effects in case of inadvertent intake of a multiple of the daily therapeutic dose. There is no specific antidote. Metrinor 20-30 mg/day (10-15 times higher dose than in Metrinor) over 24 weeks of use were very well tolerated.
