...
Use in pediatric patients : The safety and effectiveness of SB-Metvilda in pediatric patients have not been established. Therefore, SB-Metvilda is not recommended for use in children below 18 years of age. 

Use in geriatric patients : As Metformin is excreted via the kidney, and elderly patients have a tendency to decreased renal function, elderly patients taking SB-Metvilda should have their renal function monitored regularly. SB-Metvilda should only be used in elderly patients with normal renal function. 

Patients with renal impairment : SB-Metvilda should not be used in patients with renal failure or renal dysfunction, e.g. serum creatinine levels > 1.5 mg/dl (>135 micro mol/L) in males and > 1.4 mg/dl (>110 micro mol/L) in females. 

Patients with hepatic impairment : SB-Metvilda is not recommended in patients with hepatic impairment including patients with a pre-treatment ALT or AST >3 X the upper limit of normal.
