## Indications
Rolac MDT is indicated for the short-term management of moderate to severe acute post-operative pain. Rolac MDT ophthalmic solution helps relieve pain, inflammation, and light sensitivity after ocular surgery. It may also be used to decrease eye inflammation or redness caused by seasonal allergies.

## Description
Rolac MDT is a drug of pyrrolo-pyrrole group of nonsteroidal anti-inflammatory drug (NSAID). Chemically it is known as 5 benzoyle-2,3-dihydro-1H-pyrroligine-1-carboxylic acid, compound with 2 - amino-2-(hydroxymethyl)-1,3-propanediol (1:1). Rolac MDT inhibits synthesis of prostaglandins and may be considered as a peripherally acting analgesic. The biological activity of Rolac MDT is associated with the S-form. Pharmacokinetic property of Rolac MDT is linear. It is highly protein bound and is largely metabolized in liver. The products of metabolism and some unchanged drugs are excreted in the urine.
...
## Interaction
Other NSAIDs or aspirin: Increase the side effects of Rolac MDT. 
