## Indications
Humulin R Injection is indicated in- 
...
## Overdose Effects
Humulin Rs have no specific overdose definitions. However, hypoglycaemia may develop over sequential stages: 
...
## Storage Conditions
Humulin R preparations should be stored between 2°C and 8°C (in a refrigerator). Humulin R preparations which have been frozen must not be used. Humulin R preparation should be kept in the outer carton in order to protect from light. Humulin R preparations should be protected from excessive heat or sunlight. Humulin R solutions should not be used if they do not appear water-clear and colorless. When in use the vial should not be refrigerated. Once in use the vial may be used for up to 6 weeks when stored below 25°C or 4 weeks when stored below 30°C.